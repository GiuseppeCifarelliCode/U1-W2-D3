...
for (let i = 0; i < starWarsCharacters.length; i++){
  if(starWarsCharacters[i].gender === "female"){
    ...
    femaleCharacters.push(transition)
  }
}
...
for( let i = 0; i < starWarsCharacters.length; i++){
  switch(starWarsCharacters[i].eye_color){
    ...
    break;
    default: eyeColor.blueGrey.push(starWarsCharacters[i]); 
  }
} 
...
console.log("crewMass is", crewMass)
...
switch(true) {
  ...
  break;
  default : console.log("Warning: Load is over 500 and under 700")
}
